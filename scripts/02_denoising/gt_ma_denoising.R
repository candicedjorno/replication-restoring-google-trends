...
source("scripts/02_denoising/ma_denoising.R")
...
result <- ma_optimal_denoising_rmse(original, window_size)
rmses <- result$rmses
...
smoothing1 <- ma_denoising_rmse(original, window_size, rmses)
...
smoothing2 <- ma_denoising_rmse(original, window_size, rmses)
...
combined_out <- paste0("results/denoising_results/smooth_ma_gt.csv")
