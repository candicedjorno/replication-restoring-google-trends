...
save_dir = 'results/arimax_results'
...
# no exogenous
preds_h0, preds_h1, preds_h2, preds_h3, rmses_df = run_arima_all_locations(geo, clusters, save_dir, 'arimax_111', 'noexog')

# raw clusters
preds_h0, preds_h1, preds_h2, preds_h3, rmses_df = run_arimax_all_locations(geo, clusters, save_dir, 'arimax_111', 'clusters')
...
preds_h0, preds_h1, preds_h2, preds_h3, rmses_df = run_arimax_all_locations(geo, detrend, save_dir, 'arimax_111', 'detrend')
