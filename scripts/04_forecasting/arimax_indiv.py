# ARIMAX for individual raw terms and topics only
...
# individual keywords
preds_h0, preds_h1, preds_h2, preds_h3, rmses_df = run_arimax_all_locations(geo, save_dir, 'arimax_111', 'indiv')
...
# topics only
preds_h0, preds_h1, preds_h2, preds_h3, rmses_df = run_arimax_topics_all_locations(geo, save_dir, 'arimax_111', 'topics')